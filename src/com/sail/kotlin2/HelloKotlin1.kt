 ...
 * 关于数据类成员的继承药店：
 *
 * 1. 如果数据类中显式定义了equals，hashCode或是toString方法，或是在数据类的父类中将这些方法声明称了final，
 ...
 * 3. 在数据类中，显式提供componentN方法以及copy方法实现是不允许的。
 *
 * 解构声明
 *
 * 在主构造方法中有多少个参数，就会依次生成对应的component1，component2，component3，componentN
 * 这些方法返回的就是对应字段的值，而componentN方法是用来实现解构声明的
 *
 * @author yangfan
 * @date 2018/11/17
 */
 ...
 */
data class Person2(val name: String = "", val age: Int = 0, val address: String = "")
