 ...
 * 就是该匿名对象锁声明的父类型，如果没有声明任何父类型，那么其类型就是Any；在这种情况下，匿名对象
 * 中所声明的任何成员都是无法访问的。
 * @author yangfan
 * @date 2019/03/20
 */
class MyClass {
    // 这里必须加上private，否则在myTest中无法调用
    ...
    fun myTest() {
        // class com.sail.kotlin3.MyClass$myObject$1
...
class MyClass2 {
    ...
    fun test() {
        val str = method1().str
        // compile error  internal修饰的object，真实类型是Any类型
